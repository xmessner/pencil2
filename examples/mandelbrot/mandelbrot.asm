...
; Adapted to Pencil II by X. MESSNER
...
oldstack:        equ	$7000
x:               equ	$7100 ;defw    0                       ; x-coordinate
y:               equ	$7102 ;defw    0                       ; y-coordinate
z_0:             equ	$7104 ;defw    0
z_1:             equ	$7106 ;defw    0
scratch_0:       equ	$7108 ;defw    0
z_0_square_high: equ	$710A ;defw    0
z_0_square_low:  equ	$710C ;defw    0
z_1_square_high: equ	$710E ;defw    0
z_1_square_low:  equ	$7110 ;defw    0

; working area for 8 pixels at a time
primary:        equ	$7112 ;defb 0                          ; primary color
secondary:      equ	$7113 ;defb 0                          ; secondary color
pattern:        equ	$7114 ;defb 0                          ; color bit pattern
bitindex:       equ	$7115 ;defb 0                          ; current bit within byte
xypos:          equ	$7116 ;defw 0                          ; current x, y position on the screen
...
start:
	ld	(oldstack),sp			;ld	(oldstack),sp                   ; save old stack poitner
