...
; code:                 J.B Langston (https://github.com/jblang/TMS9918A)
...
curgrid:	equ	$7200 ;defw 0			; pointers to grid buffers
...
patloop:
	...
	ld	de,0
mainloop:
	ld	hl, (curgrid)		; init cell pointer
