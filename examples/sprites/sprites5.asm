...
SprAttrib:
	...
	db 52, 16,0,12 ; Y=82, X= 24, Pattern#0, Color=13
	db 52, 32,0,13 ; Y=82, X= 24, Pattern#0, Color=13
	db 52, 48,0,14 ; Y=82, X= 24, Pattern#0, Color=13
	db 60, 64,0,15 ; Y=82, X= 24, Pattern#0, Color=13
